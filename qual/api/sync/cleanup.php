<?php
/**
 * Cleanup script for StackMap sync data
 * Removes data not modified in 6 months
...
try {
    ...
    // 1. Get sync_ids that haven't been updated in 6 months
    $staleDate = date('Y-m-d H:i:s', strtotime('-6 months'));
    echo "Cleaning up data not modified since: $staleDate\n";
