...
const ReorderModal = ({
  ...
  const isReorderDisabled =
    !newPosition ||
    newPosition === reorderingActivity?.currentPosition.toString();
  ...
  return (
    ...
    >
      <View style={styles.reorderModalOverlay}>
        <View
          style={[styles.reorderModalContent, { backgroundColor: theme.light }]}
        >
              ...
              {newPosition && (
                <View style={styles.positionPreview}>
                  <Text style={styles.positionPreviewText}>
                    Move from position {reorderingActivity?.currentPosition} →{' '}
                    {newPosition}
                  </Text>
                </View>
              )}
