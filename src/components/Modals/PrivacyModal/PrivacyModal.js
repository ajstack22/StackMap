...
const PrivacyModal = ({ visible, onClose, insets, onShowSupport }) => {
  ...
  const renderContent = () => (
    <>
      <View style={styles.privacyHeader}>
        ...
        <Text style={styles.privacyDate}>Last updated: August 8, 2025</Text>
      </View>

      <View style={styles.privacySection}>
        <Text style={styles.privacySubtitle}>Overview</Text>
        <Text style={styles.privacyText}>
          StackMap is designed with privacy as a core principle. We believe
          families, especially those with special needs children, deserve tools
          that respect their privacy and give them control over their data.
        </Text>
      </View>
      ...
      <View style={styles.privacySection}>
        ...
        <Text style={styles.privacyText}>
          ...
          StackMap works entirely offline on your device.
        </Text>
      </View>
      ...
      <View style={styles.privacySection}>
        ...
        <View style={styles.privacyList}>
          <Text style={styles.privacyListItem}>
            • All routine data is stored locally on your device by default
          </Text>
          <Text style={styles.privacyListItem}>
            • No data is sent to our servers unless you enable sync
          </Text>
          <Text style={styles.privacyListItem}>
            • Your routines, progress, and settings stay on your device
          </Text>
        </View>
      </View>
      ...
      <View style={styles.privacySection}>
        ...
        <View style={styles.privacyList}>
          <Text style={styles.privacyListItem}>
            •{' '}
            <Text style={styles.privacyBold}>Zero-knowledge architecture:</Text>{' '}
            Your data is encrypted on your device before syncing
          </Text>
          <Text style={styles.privacyListItem}>
            • <Text style={styles.privacyBold}>We cannot read your data:</Text>{' '}
            Only you have the decryption key
          </Text>
          <Text style={styles.privacyListItem}>
            •{' '}
            <Text style={styles.privacyBold}>
              Your sync key is your only access:
            </Text>{' '}
            If lost, data cannot be recovered
          </Text>
          <Text style={styles.privacyListItem}>
            • <Text style={styles.privacyBold}>Automatic cleanup:</Text>{' '}
            Inactive sync data is deleted after 6 months
          </Text>
          <Text style={styles.privacyListItem}>
            • <Text style={styles.privacyBold}>No accounts required:</Text> Sync
            works with just your recovery phrase
          </Text>
        </View>
      </View>
      ...
      <View style={styles.privacySection}>
        ...
        <Text style={styles.privacyText}>
          StackMap uses minimal third-party services:
        </Text>
        <View style={styles.privacyList}>
          <Text style={styles.privacyListItem}>
            • <Text style={styles.privacyBold}>No analytics</Text> - We don't
            track usage
          </Text>
          <Text style={styles.privacyListItem}>
            • <Text style={styles.privacyBold}>No advertising</Text> - We don't
            show ads
          </Text>
          <Text style={styles.privacyListItem}>
            • <Text style={styles.privacyBold}>No external APIs</Text> -
            Everything runs locally except optional sync
          </Text>
          <Text style={styles.privacyListItem}>
            • <Text style={styles.privacyBold}>Sync servers (optional)</Text> -
            Only store encrypted data you cannot decrypt
          </Text>
        </View>
      </View>
      ...
      <View style={styles.privacyFooter}>
        <Text style={styles.privacyFooterText}>
          StackMap's code is open source. You can verify our privacy practices
          at: github.com/ajstack22/StackMap
        </Text>
      </View>
      ...
      {Platform.OS === 'web' && (
        ...
        >
          <Text style={[styles.privacySubtitle, { textAlign: 'center' }]}>
            Keep StackMap Free & Private
          </Text>
          <Text
            style={[styles.privacyText, { textAlign: 'center', marginTop: 8 }]}
          >
            We don't sell data or show ads. Your support helps us maintain our
            privacy-first approach while keeping StackMap free for families who
            need it.
          </Text>
