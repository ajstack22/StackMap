...
const containsEmoji = text => {
  ...
  const emojiRegex =
    // eslint-disable-next-line security/detect-unsafe-regex -- Emoji unicode ranges, input is bounded user text
...
const extractEmojis = text => {
  ...
  const emojiRegex =
    // eslint-disable-next-line security/detect-unsafe-regex -- Emoji property classes, input is bounded user text
