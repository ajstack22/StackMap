...
class SimpleEncryptionService {
  ...
  testUTF8(): boolean {
    try {
      ...
      console.log(
        '[SimpleEncryption] First 10 bytes:',
        Array.from(encoded.slice(0, 10)),
      );
  ...
  testMetadataEncoding(): boolean {
    try {
      ...
      console.log(
        '[SimpleEncryption] Metadata bytes length:',
        metadataBytes.length,
      );
      console.log(
        '[SimpleEncryption] Metadata bytes:',
      ...
      console.log(
        '[SimpleEncryption] Combined first 10 bytes:',
        Array.from(combined.slice(0, 10)),
      );
  ...
  encryptData(data: any): string {
    ...
    try {
      ...
      console.log(
        '[SimpleEncryption] First 10 bytes of combined:',
        Array.from(combined.slice(0, 10)),
      );
  ...
  decryptData(encryptedData: string): any {
    ...
    try {
      ...
      console.log(
        '[SimpleEncryption] Encrypted data length:',
