...
if (typeof window !== 'undefined') {
  ...
  window.showDebugSyncLogs = () => {
    ...
    div.style.cssText =
      'position:fixed;top:10px;right:10px;background:white;border:2px solid red;padding:10px;z-index:9999;max-width:400px;max-height:300px;overflow:auto;';
    div.innerHTML =
      '<h3>Debug Sync Logs</h3><pre>' + debugSync.logs.join('\n') + '</pre>';
